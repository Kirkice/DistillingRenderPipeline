...
namespace UnityEditor.Rendering.LookDev
{
    ...
    class EnvironmentElement : VisualElement, IBendable<Environment>
    {
        ...
        public VisualElement GetDefaultInspector()
        {
            ...
            {
                image = CoreEditorUtils.LoadIcon(@"Assets\Core RP Library/Editor/LookDev/Icons/", "Environment", forceLowRes: true)
            });
            ...
            {
                image = CoreEditorUtils.LoadIcon(@"Assets\Core RP Library/Editor/LookDev/Icons/", "SunPosition", forceLowRes: true)
            });
