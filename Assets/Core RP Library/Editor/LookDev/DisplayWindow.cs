...
namespace UnityEditor.Rendering.LookDev
{
    ...
    partial class DisplayWindow : EditorWindow, IViewDisplayer
    {
        ...
        {
            internal const string k_IconFolder = @"Assets\Core RP Library/Editor/LookDev/Icons/";
            internal const string k_uss = @"Assets\Core RP Library/Editor/LookDev/DisplayWindow.uss";
            internal const string k_uss_personal_overload = @"Assets\Core RP Library/Editor/LookDev/DisplayWindow-PersonalSkin.uss";
