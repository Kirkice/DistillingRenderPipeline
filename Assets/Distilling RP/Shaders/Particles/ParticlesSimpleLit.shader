...
Shader "Universal Render Pipeline/Particles/Simple Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Distilling RP/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/Distilling RP/Shaders/Particles/ParticlesSimpleLitForwardPass.hlsl"
            ENDHLSL
        }
        Pass
        {
            ...
            #include "Assets/Distilling RP/Shaders/UnlitInput.hlsl"
