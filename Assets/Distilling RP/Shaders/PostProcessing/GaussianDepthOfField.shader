Shader "Hidden/Universal Render Pipeline/GaussianDepthOfField"
{
    ...
    HLSLINCLUDE
        ...
        #include "Assets\Core RP Library/ShaderLibrary/Color.hlsl"
        #include "Assets\Core RP Library/ShaderLibrary/Filtering.hlsl"
        #include "Assets/Distilling RP/ShaderLibrary/Core.hlsl"
        #include "Assets/Distilling RP/Shaders/PostProcessing/Common.hlsl"
