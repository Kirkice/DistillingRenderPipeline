...
Shader "Universal Render Pipeline/Simple Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Distilling RP/Shaders/SimpleLitInput.hlsl"
            #include "Assets/Distilling RP/Shaders/SimpleLitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Distilling RP/Shaders/SimpleLitInput.hlsl"
            #include "Assets/Distilling RP/Shaders/SimpleLitGBufferPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Distilling RP/Shaders/SimpleLitInput.hlsl"
            #include "Assets/Distilling RP/Shaders/SimpleLitMetaPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/Distilling RP/Shaders/SimpleLitInput.hlsl"
            #include "Assets/Distilling RP/Shaders/Utils/Universal2D.hlsl"
            ENDHLSL
        }
    }
