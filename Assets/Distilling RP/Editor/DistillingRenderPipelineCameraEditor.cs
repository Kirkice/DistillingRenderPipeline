...
{
    [CustomEditorForRenderPipeline(typeof(Camera), typeof(DistillingRenderPipelineAsset))]
    [CanEditMultipleObjects]
    class DistillingRenderPipelineCameraEditor : CameraEditor
    {
        ...
        DistillingRenderPipelineAsset m_UniversalRenderPipeline;
        DistillingAdditionalCameraData m_AdditionalCameraData;
        ...
        {
            m_UniversalRenderPipeline = DistillingRenderPipeline.asset;
            ...
            m_AdditionalCameraData = camera.gameObject.GetComponent<DistillingAdditionalCameraData>();
            ...
            {
                m_AdditionalCameraData = camera.gameObject.AddComponent<DistillingAdditionalCameraData>();
            }
        ...
        void UpdateCameras()
        {
            var o = new PropertyFetcher<DistillingAdditionalCameraData>(m_AdditionalCameraDataSO);
        ...
        void DrawElementCallback(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            if (cam != null)
            {
                bool warning = false;
                string warningInfo = "";
                var type = cam.gameObject.GetComponent<DistillingAdditionalCameraData>().renderType;
                ...
                else
                {
                    ...
                    var isPostActive = cam.gameObject.GetComponent<DistillingAdditionalCameraData>().renderPostProcessing;
                    if (isPostActive)
                    {
            ...
            {
                camera.GetComponent<DistillingAdditionalCameraData>().UpdateCameraStack();
        ...
        void AddCameraToCameraList(Rect rect, ReorderableList list)
        {
            ...
            {
                var component = camera.gameObject.GetComponent<DistillingAdditionalCameraData>();
                if (component != null)
                {
        ...
        void init(DistillingAdditionalCameraData additionalCameraData)
        {
...
//#endif
        ...
        void DrawPostProcessingOverlay()
        {
            ...
            if (hasChanged)
            {
                if (m_AdditionalCameraDataSO == null)
                {
                    m_AdditionalCameraData = Undo.AddComponent<DistillingAdditionalCameraData>(camera.gameObject);
                    init(m_AdditionalCameraData);
                }
        ...
        void DrawRenderer()
        {
            ...
            int selectedRenderer = EditorGUI.IntPopup(controlRect, Styles.rendererType, selectedRendererOption, m_UniversalRenderPipeline.rendererDisplayList, DistillingRenderPipeline.asset.rendererIndexList);
    ...
    [ScriptableRenderPipelineExtension(typeof(DistillingRenderPipelineAsset))]
    class UniversalRenderPipelineCameraContextualMenu : IRemoveAdditionalDataContextualMenu<Camera>
    {
        ...
        public void RemoveComponent(Camera camera, IEnumerable<Component> dependencies)
        {
            ...
            dependencies = dependencies.Where(c => c.GetType() != typeof(DistillingAdditionalCameraData));
            ...
            var additionalCameraData = camera.GetComponent<DistillingAdditionalCameraData>();
