...
namespace UnityEditor.Rendering.Distilling
{
    class FBXArnoldSurfaceMaterialDescriptionPreprocessor : AssetPostprocessor
    {
        ...
        static readonly string k_ShaderPath = "Assets/Distilling RP/Runtime/Materials/ArnoldStandardSurface/ArnoldStandardSurface.shadergraph";
        static readonly string k_ShaderTransparentPath = "Assets/Distilling RP/Runtime/Materials/ArnoldStandardSurface/ArnoldStandardSurfaceTransparent.shadergraph";
