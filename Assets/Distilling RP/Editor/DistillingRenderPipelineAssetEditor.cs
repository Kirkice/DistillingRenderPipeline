...
{
    [CustomEditor(typeof(DistillingRenderPipelineAsset))]
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class DistillingRenderPipelineAssetEditor : Editor
    {
        ...
        void DrawGeneralSettings()
        {
            ...
            if (m_GeneralSettingsFoldout.value)
            {
                ...
                DistillingRenderPipelineAsset asset = target as DistillingRenderPipelineAsset;
        ...
        void DrawQualitySettings()
        {
            ...
            if (m_QualitySettingsFoldout.value)
            {
                ...
                m_RenderScale.floatValue = EditorGUILayout.Slider(Styles.renderScaleText, m_RenderScale.floatValue, DistillingRenderPipeline.minRenderScale, DistillingRenderPipeline.maxRenderScale);
                EditorGUI.EndDisabledGroup();
                EditorGUI.indentLevel--;
                EditorGUILayout.Space();
                EditorGUILayout.Space();
        ...
        void DrawLightingSettings()
        {
            ...
            if (m_LightingSettingsFoldout.value)
            {
                ...
                EditorGUI.BeginDisabledGroup(disableGroup);
                m_AdditionalLightsPerObjectLimitProp.intValue = EditorGUILayout.IntSlider(Styles.perObjectLimit, m_AdditionalLightsPerObjectLimitProp.intValue, 0, DistillingRenderPipeline.maxPerObjectLights);
                EditorGUI.EndDisabledGroup();
        ...
        void DrawShadowSettings()
        {
            ...
            if (m_ShadowSettingsFoldout.value)
            {
                ...
                m_ShadowDepthBiasProp.floatValue = EditorGUILayout.Slider(Styles.shadowDepthBias, m_ShadowDepthBiasProp.floatValue, 0.0f, DistillingRenderPipeline.maxShadowBias);
                m_ShadowNormalBiasProp.floatValue = EditorGUILayout.Slider(Styles.shadowNormalBias, m_ShadowNormalBiasProp.floatValue, 0.0f, DistillingRenderPipeline.maxShadowBias);
        ...
        void DrawPostProcessingSettings()
        {
            ...
            if (m_PostProcessingSettingsFoldout.value)
            {
                ...
                if (!ppv2Enabled)
                {
                    ...
                    m_ColorGradingLutSize.intValue = Mathf.Clamp(m_ColorGradingLutSize.intValue, DistillingRenderPipelineAsset.k_MinLutSize, DistillingRenderPipelineAsset.k_MaxLutSize);
        ...
        void DrawRendererListLayout(ReorderableList list, SerializedProperty prop)
        {
            list.drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused) =>
            {
                ...
                else // Missing ScriptableRendererData
                {
                    ...
                    {
                        EditorGUIUtility.ShowObjectPicker<UnityEngine.Rendering.Distilling.ScriptableRendererData>(null, false, null, index);
                    }
                }
            ...
            list.onCanAddCallback = li => { return li.count < DistillingRenderPipeline.maxScriptableRenderers; };
