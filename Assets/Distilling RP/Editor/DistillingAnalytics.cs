...
{
    class DistillingAnalytics : IPostprocessBuildWithReport
    {
        ...
        static void SendUniversalEvent()
        {
            ...
            DistillingRenderPipelineAsset rendererAsset = GraphicsSettings.currentRenderPipeline as DistillingRenderPipelineAsset;
