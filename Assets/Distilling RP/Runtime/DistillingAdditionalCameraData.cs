...
namespace UnityEngine.Rendering.Distilling
{
    ...
    public static class CameraExtensions
    {
        ...
        public static DistillingAdditionalCameraData GetUniversalAdditionalCameraData(this Camera camera)
        {
            var gameObject = camera.gameObject;
            bool componentExists = gameObject.TryGetComponent<DistillingAdditionalCameraData>(out var cameraData);
            if (!componentExists)
                cameraData = gameObject.AddComponent<DistillingAdditionalCameraData>();
    ...
    [MovedFrom("UnityEngine.Rendering.LWRP")] public class DistillingAdditionalCameraData : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        static DistillingAdditionalCameraData s_DefaultAdditionalCameraData = null;
        internal static DistillingAdditionalCameraData defaultAdditionalCameraData
        {
            get
            {
                if (s_DefaultAdditionalCameraData == null)
                    s_DefaultAdditionalCameraData = new DistillingAdditionalCameraData();
        ...
        public bool requiresDepthTexture
        {
            get
            {
                ...
                {
                    return DistillingRenderPipeline.asset.supportsCameraDepthTexture;
                }
                else
                {
        ...
        public bool requiresColorTexture
        {
            get
            {
                ...
                {
                    return DistillingRenderPipeline.asset.supportsCameraOpaqueTexture;
                }
                else
                {
        ...
        {
            get => DistillingRenderPipeline.asset.GetRenderer(m_RendererIndex);
        }
        ...
        {
            string path = "Assets/Distilling RP/Editor/Gizmos/";
            string gizmoName = "";
