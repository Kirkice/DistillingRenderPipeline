...
{
    public sealed partial class DistillingRenderPipeline : RenderPipeline
    {
        ...
        public DistillingRenderPipeline(DistillingRenderPipelineAsset asset)
        {
        ...
        {
            DistillingAdditionalCameraData additionalCameraData = null;
            if (IsGameCamera(camera))
        ...
        {
            baseCamera.TryGetComponent<DistillingAdditionalCameraData>(out var baseCameraAdditionalData);
            ...
            if (cameraStack != null && cameraStack.Count > 0)
            {
                ...
                if (!IsMultiPassStereoEnabled(baseCamera))
                {
                    ...
                    for (int i = 0; i < cameraStack.Count; ++i)
                    {
                        ...
                        {
                            currCamera.TryGetComponent<DistillingAdditionalCameraData>(out var data);
                            ...
                            {
                                var renderer2DType = typeof(Experimental.Rendering.Distilling.Renderer2D);
            ...
            for (int i = 0; i < cameraStack.Count; ++i)
            {
                ...
                currCamera.TryGetComponent<DistillingAdditionalCameraData>(out var currCameraData);
        ...
        static void UpdateVolumeFramework(Camera camera, DistillingAdditionalCameraData additionalCameraData)
        {
            ...
            else if (camera.cameraType == CameraType.SceneView)
            {
                ...
                DistillingAdditionalCameraData mainAdditionalCameraData = null;
        ...
        static void InitializeCameraData(Camera camera, DistillingAdditionalCameraData additionalCameraData, bool resolveFinalTarget, out CameraData cameraData)
        {
        ...
        static void InitializeStackedCameraData(Camera baseCamera, DistillingAdditionalCameraData baseAdditionalCameraData, ref CameraData cameraData)
        {
            var settings = asset;
        ...
        static void InitializeAdditionalCameraData(Camera camera, DistillingAdditionalCameraData additionalCameraData, bool resolveFinalTarget, ref CameraData cameraData)
        {
            var settings = asset;
...
#pragma warning restore 0618
        ...
        static void InitializeRenderingData(DistillingRenderPipelineAsset settings, ref CameraData cameraData, ref CullingResults cullResults,
...
#pragma warning restore
        ...
        static void InitializeShadowData(DistillingRenderPipelineAsset settings, NativeArray<VisibleLight> visibleLights, bool mainLightCastShadows, bool additionalLightsCastShadows, out ShadowData shadowData)
        {
            ...
            {
                Light light = visibleLights[i].light;
                DistillingAdditionalLightData data = null;
                if (light != null)
                {
        ...
        static void InitializePostProcessingData(DistillingRenderPipelineAsset settings, out PostProcessingData postProcessingData)
        {
        ...
        static void InitializeLightData(DistillingRenderPipelineAsset settings, NativeArray<VisibleLight> visibleLights, int mainLightIndex, out LightData lightData)
        {
            int maxPerObjectAdditionalLights = DistillingRenderPipeline.maxPerObjectLights;
            int maxVisibleAdditionalLights = DistillingRenderPipeline.maxVisibleAdditionalLights;
        ...
        static int GetMainLightIndex(DistillingRenderPipelineAsset settings, NativeArray<VisibleLight> visibleLights)
        {
