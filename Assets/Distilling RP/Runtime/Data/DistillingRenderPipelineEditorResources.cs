...
{
    [MovedFrom("UnityEngine.Rendering.DistillingRP")] public class DistillingRenderPipelineEditorResources : ScriptableObject
    {
...
#if UNITY_EDITOR
    [UnityEditor.CustomEditor(typeof(DistillingRenderPipelineEditorResources), true)]
    class DistillingRenderPipelineEditorResourcesEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            {
                var resources = target as DistillingRenderPipelineEditorResources;
